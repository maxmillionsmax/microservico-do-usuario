package br.com.max.payrollapi.services;

import br.com.max.payrollapi.domain.Payroll;
import br.com.max.payrollapi.feignClients.UserFeign;
import br.com.max.payrollapi.services.exceptions.ObjectNotFoundException;
    ...
    public Payroll getPayment(Long workedId, Payroll payroll){
      ...
      try {
        ...
        throw new ObjectNotFoundException("Object not found");
          ...
          throw new IllegalArgumentException("Illegal argument excepiton");
      }
      return  null;
    }
}
